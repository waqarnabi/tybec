...
define void @kernelInput(i32 %aIn0, i32 %aIn1, i32 %aIn2, i32 %ch00, i32 %ch01, i32 %ch02) #0 {
  ...
  %3 = trunc i32 %ch02 to i8
  call void @write_pipe(i8 signext %3, i32* %data2)
  ret void
}

; Function Attrs: nounwind ssp uwtable
define void @kernelCompute(i32 %ch00, i32 %ch01, i32 %ch02, i32 %ch1) #0 {
  %dataIn0 = alloca i32, align 4
  %dataIn1 = alloca i32, align 4
  %dataIn2 = alloca i32, align 4
  ...
  %3 = trunc i32 %ch02 to i8
  call void @read_pipe(i8 signext %3, i32* %dataIn2)
  %4 = load i32, i32* %dataIn0, align 4
  %5 = load i32, i32* %dataIn1, align 4
  %6 = add nsw i32 %4, %5
  %7 = load i32, i32* %dataIn2, align 4
  %8 = add nsw i32 %6, %7
