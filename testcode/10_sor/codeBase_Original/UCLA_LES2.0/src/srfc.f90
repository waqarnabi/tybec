...
contains 
  ...
  subroutine surface
    ...
    use grid, only: nzp, nxp, nyp, a_up, a_vp, a_theta, a_rv, zt, psrf, th00  &
         , umean, vmean, a_ustar, a_tstar, a_rstar, uw_sfc, vw_sfc, ww_sfc    &
         , wt_sfc, wq_sfc, dn0, level
    use thrm, only: rslf
    ...
    case(2)
       ...
       do j=3,nyp-2
          do i=3,nxp-2
             ...
             drdz(i,j) = a_rv(2,i,j) - rslf(psrf,sst)
   ...
   case(4)
       ...
       do j=3,nyp-2
          do i=3,nxp-2
             ...
             wq_sfc(i,j) = Vbulk * (rslf(psrf,sst) - a_rv(2,i,j))
             wspd(i,j)    = max(0.1,                                    &
